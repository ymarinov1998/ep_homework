...
public class MultiplicativeAssignmentNode extends AssignmentNode {
    VariableNode variable;
    AssignableNode assignable;

    public MultiplicativeAssignmentNode(VariableNode variable, AssignableNode assignable) {
    ...
    public void printNode(int tabCount) {
        System.out.printf("%s%s%n", "\t".repeat(Math.max(0, tabCount)), "<multiplicative assignment>");
